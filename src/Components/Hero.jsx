  ...
  return (
    <div>
        ...
        <div className="flex flex-col mt-5">
            ...
            <input type="text" value={searchTerm} onChange={onSearchChange} className="p-2.5 pl-4 border w-[100%] rounded-[0.7rem] mt-4 mb-4 sm:mb-4 sm:w-[50%] sm:m-[auto] lg:m-[auto] lg:w-[40%] "
